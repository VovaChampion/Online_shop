...
require_once('lib/product_class.php');
    ...
    // The "back" link
    $prevlink = ($page > 1) ? '<a href="?page=1" title="First page"><i class="fas fa-angle-double-left"></i></a><a href="?page=' . ($page - 1) . '" title="Previous page"><i class="fas fa-angle-left"></i></a>' : '<span class="disabled"><i class="fas fa-angle-double-left"></i></span> <span class="disabled"><i class="fas fa-angle-left"></i></span>';
